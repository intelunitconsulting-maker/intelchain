...
The platform combines **SHA-256 integrity verification** with **RFC3161 trusted timestamping** to establish independently verifiable evidence records while ensuring that evidence remains under the user's control at all times.
...
IntelChain Community is distributed under the terms of the accompanying End User License Agreement (EULA).

Use of IntelChain Community constitutes acceptance of the conditions set forth in the EULA.

See the `EULA.txt` file included with the software and repository for complete licensing information.
